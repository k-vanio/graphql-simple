...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	courses, err := r.CourseModel.FindByCategoryId(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *courseResolver) Category(ctx context.Context, obj *model.Course) (*model.Category, error) {
	category, err := r.CategoryModel.FindByCourseId(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCategory(ctx context.Context, input model.NewCategory) (*model.Category, error) {
	category, err := r.CategoryModel.Create(input.Name, *input.Description)
	if err != nil {
		return nil, err
	}
	return &model.Category{
...
func (r *mutationResolver) CreateCourse(ctx context.Context, input model.NewCourse) (*model.Course, error) {
	course, err := r.CourseModel.Create(input.Name, *input.Description, input.CategoryID)
	if err != nil {
		return nil, err
	}
	return &model.Course{
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	categories, err := r.CategoryModel.FindAll()
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Courses(ctx context.Context) ([]*model.Course, error) {
	courses, err := r.CourseModel.FindAll()
	if err != nil {
		return nil, err
	}
